...
class Profile
{
  protected:
    Language lang_;
    std::unordered_map<std::uint32_t, std::size_t> oneGrams_;
    std::unordered_map<std::tuple<std::uint32_t, std::uint32_t>, std::size_t> bigrams_;
    std::unordered_map<std::tuple<std::uint32_t, std::uint32_t, std::uint32_t>, std::size_t> trigrams_;
    std::tuple<std::uint32_t, std::uint32_t, std::uint32_t> nWords_;
    Profile() = default;
